...
case class Level(width: Int, height: Int, size: Int, hasSnow: Boolean, character: Location, balls: List[Location], map: SortedMap[Coordinate, Location], override val toString: String) {
